...
class PaginationServiceTest {
    ...
    static Stream<Arguments> givenCurrentPageNumberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers() {
        return Stream.of(
                arguments(0, 1, List.of(0)),
                arguments(0, 13, List.of(0, 1, 2, 3, 4)),
                arguments(1, 13, List.of(0, 1, 2, 3, 4)),
                arguments(2, 13, List.of(0, 1, 2, 3, 4)),
                arguments(3, 13, List.of(0, 1, 2, 3, 4)),
                arguments(4, 13, List.of(0, 1, 2, 3, 4)),
                arguments(5, 13, List.of(5, 6, 7, 8, 9)),
                arguments(6, 13, List.of(5, 6, 7, 8, 9)),
                arguments(10, 13, List.of(10, 11, 12)),
                arguments(11, 13, List.of(10, 11, 12)),
